 ...
 * emission boundary. Registered as the {@code %msg} / {@code %m} pattern converter in {@code
 * logback-spring.xml}, so every log line written by every appender is masked before it leaves the
 * JVM.
 *
